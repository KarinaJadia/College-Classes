...
void removeMatch(vector<string *> &string_pointers, string *to_remove) {
        //your code here
        for (vector<string *>::iterator curr_string = string_pointers.begin(); curr_string != string_pointers.end(); ) {
                if (*curr_string == to_remove) {
                        curr_string = string_pointers.erase(curr_string);
                } else {
                        ++curr_string;
                }
        }
