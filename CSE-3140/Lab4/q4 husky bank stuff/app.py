...
def manager():
    file = open('C:\\Users\\karin\\OneDrive - University of Connecticut\\Documents\\CSE 3140\\Lab4\\husky bank stuff\\log.txt', 'r')
    return file.read()
...
def submit_form(): # activates when user submits
    ...
    with open('C:\\Users\\karin\\OneDrive - University of Connecticut\\Documents\\CSE 3140\\Lab4\\husky bank stuff\\log.txt', 'a') as file:
