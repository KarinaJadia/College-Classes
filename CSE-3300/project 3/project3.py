...
class final_topo(Topo):
  def build(self):
    ...
    # connect everything to server
    self.addLink(s1, s5, port1=2, port2=2)
    self.addLink(s2, s5, port1=2, port2=3)
    self.addLink(s3, s5, port1=2, port2=4)
    self.addLink(s4, s5, port1=2, port2=5)
